...
class PGAgent(BaseAgent):
    def __init__(self, env, agent_params):
        ...
        print("discrete",self.agent_params['discrete'])
    ...
    def _discounted_return(self, rewards):
        ...
        list_of_discounted_returns = np.ones(len(rewards)) * np.sum(np.power(self.gamma, np.arange(len(rewards)))*np.array(rewards))
    ...
    def _discounted_cumsum(self, rewards):
        ...
        # TODO: create `list_of_discounted_cumsums`
        ...
        for t in range(len(rewards)): 
            list_of_discounted_cumsums.append(np.sum(np.array(rewards[t:])*np.power(self.gamma, np.arange(t,len(rewards)) - t)))
